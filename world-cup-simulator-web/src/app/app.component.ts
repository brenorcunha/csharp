...
//Dando problema na importação aqui, vai no 'tsconfig.json' em importHelpers: Põe false.
})
export class AppComponent implements OnInit {
  constructor(service: TeamsService) {
    service.getGroups().subscribe((groups: Team[][]) => {
      this.groups = groups;
...
//Implementacoes finais para 
  changeQuarter(lastMatch: number, winner: Team) {
    ...
    //Para corrigir BUG que não redefinia se mudarmos o time vencedor de uma partida anterior: 
